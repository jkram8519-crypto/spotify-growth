    ...
    <main style={{background:'#000',color:'#fff',fontFamily:'sans-serif',minHeight:'100vh',padding:'60px 20px'}}>
      <div style={{maxWidth:'800px',margin:'0 auto'}}>
        ...
        {[
          ...
          {emoji:'🗓️',titre:'Manager IA — Version Avancée',desc:'Planning de sortie étendu avec des actions supplémentaires sur 60 jours. Inclut des stratégies avancées de promotion, de collaboration et de distribution.',badge:'AVANCÉ'},
